...
class Realty(models.Model):
    ...
    tags = ArrayField(models.CharField(max_length=200), blank=True, default=list, verbose_name='Тэги')
    category = models.ForeignKey('Category', on_delete=models.PROTECT, verbose_name='Категория')
    saller = models.ForeignKey('Saller', on_delete=models.CASCADE, verbose_name='Продавец')
